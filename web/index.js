...
(function() {
  ...
  function Runner(outerContainerId, opt_config) {
    ...
    this.outerContainerEl = window.document.querySelector(outerContainerId);
  ...
  Runner.prototype = {
    ...
    update: async function() {
      ...
      if (hasObstacles) {
        const nearestObstacle = this.horizon.obstacles.find(
          obstacle => obstacle.xPos >= this.tRex.xPos
        );
    ...
    gameOver: async function() {
      ...
      // Using next genome, restarting the game
      const currentScore = parseInt(this.distanceMeter.digits.join(''));
      await b.nextGenome(currentScore);
      this.restart();
    },
  ...
  Trex.prototype = {
    ...
    update: function(deltaTime, opt_status) {
      ...
      //   console.log("trex position", this.xPos, this.yPos);
      //   console.log("Nearest obstacle: ", this.obstacles);
    },
    ...
    draw: function(x, y) {
      ...
      //   const imageData = ctx.getImageData(dim.x, dim.y, dim.w, dim.h);

      //   for (let i = 0; i < imageData.data.length; i += 4) {
      //     imageData.data[i] = 255;
      //     imageData.data[i + 1] = 0;
      //     imageData.data[i + 2] = 0;
      //     imageData.data[i + 3] = 122;
      //   }

      //   ctx.putImageData(imageData, dim.x, dim.y);
      // };
      // recolorSight(this.canvasCtx);
    },
    ...
    setDuck: function(isDucking) {
      console.log('setting duck: ', isDucking);
